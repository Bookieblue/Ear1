...
const BenefitCard = ( {title, description, img} : BenefitProps) => {
 return (
   <div className="relative z-20" >
        <Image src={img} alt="benefit" width={50} height={50} className="absolute z-20 -top-4 left-[45%]" />
...
const Benefit = () => {
  return (
    <section id='benefit' data-aos="fade-up" className="max-container padding-container pt-5 md:px-20 pb-20 lg:pb-32  md:gap-28 lg:py-20 relative">
      <div className="flexCenter max-container flex flex-col xl:flex-row relative">
        <div className="relative">
          ...
          <Image
            ...
            width={300}
            height={700}
            className=" ml-12 mt-24 hidden lg:block"
          />
        </div>
        <div className="grid grid-cols-1 top-56 gap-10 md:grid-cols-2 lg:gap-x-96 lg:gap-y-16 lg:absolute">
        {BENEFIT.map((benefit)=>(
            <BenefitCard
            key={benefit.title}
            title={benefit.title}
        ...
        <Image
          ...
          width={700}
          height={670}
          className="absolute mt-32 -z-20 hidden md:block md:w-[50%]"
        />
      </div>
